import { Fragment, reactive, computed, watchEffect, toRefs, capitalize, shallowRef, warn, getCurrentInstance as getCurrentInstance$1, ref, unref, provide, defineComponent as defineComponent$1, createVNode, mergeProps, inject as inject$1, version as version$1, toRaw, h, shallowReactive, watch, Suspense, nextTick, Transition, hasInjectionContext, onScopeDispose, useSSRContext, createApp, effectScope, getCurrentScope, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, toRef, defineAsyncComponent, isReadonly, withCtx, isRef, isShallow, isReactive } from 'vue';
import { $ as $fetch, l as hasProtocol, m as isScriptProtocol, n as joinURL, w as withQuery, o as defu, p as sanitizeStatusCode, q as createHooks, h as createError$1, t as toRouteMatcher, r as createRouter$1, v as getRequestHeaders } from '../runtime.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-hvN5IeTS.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-D53mo1oD.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CO9SfFNH.mjs'));
...
export { findChildrenWithProvide as A, consoleWarn as B, wrapInArray as C, useRtl as D, hasEvent as E, isObject as F, keyCodes as G, breakpoints as H, IconValue as I, useDisplay as J, clamp as K, injectHead as L, resolveUnrefHeadInput as M, _export_sfc as _, navigateTo as a, useNuxtApp as b, useRuntimeConfig as c, destructComputed as d, entry$1 as default, isCssColor as e, isParsableColor as f, getCurrentInstance as g, parseColor as h, includes as i, getForeground as j, getCurrentInstanceName as k, convertToUnit as l, makeThemeProps as m, nuxtLinkDefaults as n, genericComponent as o, propsFactory as p, provideTheme as q, resolveRouteObject as r, useIcon as s, templateRef as t, useRouter as u, flattenFragments as v, provideDefaults as w, getUid as x, useProxiedModel as y, deepEqual as z };
